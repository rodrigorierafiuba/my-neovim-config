...
## AI-Free by design
This configuration intentionally does not include AI code completion tools such as GH Copilot, Codeium, Supermaven or Tabnine.
Autocompletion is provided through the language servers and traditional completion sources.
...
I'll keep improving this configuration as I use Neovim. New changes will be pushed to the main branch of this repository. To keep your local setup updated, simply run:
Pull changes:
...
The goal is to combine vim's editing model with modern development tooling while keeping the enviroment fast, understandable and under your control (with a smooth cursor that actually looks insane btw)
Also, there is no AI-generated implementations, no unnecesary abstraction, no magic you can't inspect.
